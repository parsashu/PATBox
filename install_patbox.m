...
% =========================================================================
    ...
    addpath(fullfile(pkg_root, 'physics'));
    addpath(fullfile(pkg_root, 'geometry'));
    addpath(fullfile(pkg_root, 'noise'));
...
function enableAutoLoad()
    ...
    hook = [ ...
        ...
        '    addpath(root, fullfile(root, ''recon''), fullfile(root, ''simulation''), ...' newline ...
        '        fullfile(root, ''physics''), fullfile(root, ''geometry''), ...' newline ...
        '        fullfile(root, ''noise''), fullfile(root, ''utils''));' newline ...
