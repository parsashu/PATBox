...
<body>
  <header class="site-header">
    <div class="nav-inner">
      <a class="brand" href="index.html">PATBox <span>v0.6.7-physics-core</span></a>
      <nav class="nav-links">
          {nav}
...
{body}
  ...
  <footer class="site-footer">
    <div class="inner">
      <div>PATBox · MIT License · Built on <a href="http://www.k-wave.org/" target="_blank" rel="noopener">k-Wave</a></div>
