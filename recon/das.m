...
% 
% Component: Standard Delay-and-Sum (DAS) Reconstruction Engine
% Authors:   Parsa Shahidi & Bahareh Khishkhah
% Date:                      June 2026
%
% Description:
%   This function implements the foundational Delay-and-Sum (DAS) backprojection 
%   algorithm for photoacoustic tomography. It maps the spatial acoustic 
%   Time-of-Flight (ToF) from each pixel to the transducer locations, performs 
%   sub-sample temporal interpolation (supporting nearest, linear, or cubic 
%   methods), and coherently sum the pressure signals to reconstruct the initial 
%   pressure distribution (p0).
% =========================================================================

function p0_recon = das(sensor_data, sensor_mask, kgrid, sound_speed, varargin)
    ...
    % DAS reconstruction: for each pixel, sum delayed sensor signals
    fprintf('Performing DAS reconstruction...\n');
    ...
    fprintf('DAS reconstruction completed.\n');
